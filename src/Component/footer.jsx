        ...
        <div>
            <div className=' w-full flex justify-between bg-white h-48 md:56 lg:h-56'>
                <div className='flex flex-col md:grid lg:grid justify-start gap-5'>
                    <h1 onClick={goToHome} className='cursor-pointer h-fit text-2xl lg:text-6xl text-orange-600 font-extrabold'>SipN'Bite</h1>
                ...
                <div className='flex flex-col lg:relative lg:grid md:grid gap-1 lg:gap-0 m-4'>
                    ...
                    <a href="public/Ieela_Resume.pdf"
                        download
                        target="_blank"
              ...
              hover:after:w-full">
                    ...
                    <a href="https://leela-krishna-ecom.netlify.app/login" target="_blank"
                        rel="noopener noreferrer"
                        className="  text-black font-light after:content-[''] after:absolute after:left-0 after:bottom-0 
              after:h-[2px] after:w-0 after:bg-orange-500 after:transition-all after:duration-300 
              hover:after:w-full">
